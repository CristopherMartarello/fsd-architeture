    ...
    <div className="p-6">
      <div className="flex gap-6">
        {author.photoId ? (
          ...
          <div className="w-32 h-32 rounded-full bg-paper-surface flex items-center justify-center text-paper-ink/40 text-3xl font-bold shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          {author.bio && (
            <p className="text-paper-muted text-sm mt-3 whitespace-pre-line line-clamp-6">
              {author.bio}
            </p>
          )}
          {author.link && (
